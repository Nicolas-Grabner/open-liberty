 ...
 * <p>
 * Compare with {@link SharedFeatureLibImpl4_1_removed}, which implements the
 * already-cached {@code TestFeatureApi} and whose load outcome reveals whether the
 * loader was evicted at all.
 */
public class SharedFeatureLibImpl4_2 implements TestFeatureApi2 {
    @Override
    public String doWork() {
        return "SharedFeatureLibImpl4_2.doWork() called successfully — Test 4 State 2 (fresh interface)";
    }
}
