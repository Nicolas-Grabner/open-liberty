...
/**
 * Test 4, State 2 "removed" success probe.
 * <p>
 ...
 * <p>
 * Compare with {@link SharedFeatureLibImpl4_2}, which implements the never-before-seen
 * {@code TestFeatureApi2} and is expected to produce a {@link NoClassDefFoundError}
 * if the loader was properly evicted.
 */
public class SharedFeatureLibImpl4_1_removed implements TestFeatureApi {

    @Override
    public String doWork() {
        return "SharedFeatureLibImpl4_1_removed.doWork() called successfully — Test 4 State 2 (cached interface)";
    }
}
