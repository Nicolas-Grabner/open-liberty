...
/**
 * Second in-WAR implementation of {@link TestFeatureApi}, used exclusively by
 * the State 2 probe of Test 1 (direct application dependency test).
 * <p>
 ...
 */
public class TestFeatureApiImpl2 implements TestFeatureApi {

    @Override
    public String doWork() {
        return "TestFeatureApiImpl2.doWork() called successfully (state 2)";
    }
}
