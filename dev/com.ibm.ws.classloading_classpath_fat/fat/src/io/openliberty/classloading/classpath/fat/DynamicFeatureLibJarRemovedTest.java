...
/**
 * FAT test for the dynamic feature lifecycle classloader baseline (Test 4).
 *
 ...
 * </ol>
 *
 * <p><b>Contrast with Tests 2 and 3:</b> Those tests remove the feature without
 ...
 * ({@code CLASS_STILL_VISIBLE}). Test 4 modifies the library config, triggering the
