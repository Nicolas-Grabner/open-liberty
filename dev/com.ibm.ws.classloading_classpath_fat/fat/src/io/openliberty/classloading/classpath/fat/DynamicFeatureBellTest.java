...
public class DynamicFeatureBellTest {
    ...
    private static final String SERVLET_PATH =
        TEST_DYNAMIC_FEATURE_BELL_APP + "/DynamicFeatureLifecycleTestServlet";
    ...
    public void testDynamicFeatureBellLifecycle() throws Exception {
        ...
        FATServletClient.runTest(server, SERVLET_PATH, "testBellLibraryDependsOnFeatureApi_FeaturePresent");
        ...
        FATServletClient.runTest(server, SERVLET_PATH,
            "testBellLibraryDependsOnFeatureApi_FeatureRemoved_CachedInterface");
        assertNotNull("State 2a SUCCESS marker not found in log",
                      server.waitForStringInLogUsingMark("DYNAMIC_FEATURE_BELL_TEST STATE2a - SUCCESS"));

        // State 2b: fresh-interface probe — expects NCDFE (TestFeatureApi2 never cached, bundle gone)
        server.setMarkToEndOfLog();
        FATServletClient.runTest(server, SERVLET_PATH,
            "testBellLibraryDependsOnFeatureApi_FeatureRemoved_FreshInterface");
        assertNotNull("State 2b NCDFE/CNFE marker not found in log",
                      server.waitForStringInLogUsingMark("DYNAMIC_FEATURE_BELL_TEST STATE2b -"));
        ...
        server.setMarkToEndOfLog();
        FATServletClient.runTest(server, SERVLET_PATH, "testBellLibraryDependsOnFeatureApi_FeatureReAdded");
    ...
    public static void stopServer() throws Exception {
        ...
        // Liberty correctly refreshes the Bell library AppClassLoader on feature re-add.
